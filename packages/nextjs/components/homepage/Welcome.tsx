...
const Welcome = () => {
  return (
    <div className="md:text-sm text-[0.7rem] border rounded-xl p-4">
      ...
      <p>
        🚀 LaunchPod is on a mission to uplift the Ethereum ecosystem! 🌍 By offering monthly UBI to high-impact devs, we're spotlighting their invaluable contributions to our shared digital future. 🛠️
      </p>
      <p>
