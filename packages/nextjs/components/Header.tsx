...
export const Header = () => {
  ...
  const navLinks = (
    <div className="lg:flex lg:flex-row text-3xl">
      <li>
  ...
  return (
    <div className="sticky top-[1rem] mx-auto place-self-center navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-20 shadow-sm w-[94%] lg:w-[98%] rounded-xl">
